  ...
  const Message = ({ message }) => (
    ...
    >
      ...
      <div className="message-header">
        <span className="message-role">{message.role === 'user' ? 'You' : 'Kayy AI'}</span>
      </div>
